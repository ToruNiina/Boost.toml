...
{
    TOML_PARSE_CHECK_EQUAL(parse_value, "07:32:00",
        value, value(hours(7) + minutes(32)));
    TOML_PARSE_CHECK_EQUAL(parse_value, "07:32:00.99",
        value, value(hours(7) + minutes(32) + milliseconds(990)));
    TOML_PARSE_CHECK_EQUAL(parse_value, "07:32:00.999",
        value, value(hours(7) + minutes(32) + milliseconds(999)));
    TOML_PARSE_CHECK_EQUAL(parse_value, "07:32:00.999999",
        value, value(hours(7) + minutes(32) + milliseconds(999) + microseconds(999)));
}
...
{
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27",
        value, value(toml::date(1979, 5, 27)));
}
...
{
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27T07:32:00",
        value, value(toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32)));
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27T07:32:00.99",
        value, value(toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32) +
            toml::milliseconds(990)));
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27T07:32:00.999999",
        value, value(toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32) +
            toml::milliseconds(999) + toml::microseconds(999)));

    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27 07:32:00",
        value, value(toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32)));
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27 07:32:00.99",
        value, value(toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32) +
            toml::milliseconds(990)));
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27 07:32:00.999999",
        value, value(toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32) +
            toml::milliseconds(999) + toml::microseconds(999)));
}
...
{
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27T07:32:00Z",
        value, value(toml::local_datetime(
            toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32)),
            time_zone_ptr(new boost::local_time::posix_time_zone("UTC"))));
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27T07:32:00.99Z",
        value, value(toml::local_datetime(toml::date(1979, 5, 27),
            toml::hours(7) + toml::minutes(32) + toml::milliseconds(990)),
            time_zone_ptr(new boost::local_time::posix_time_zone("UTC"))));
    TOML_PARSE_CHECK_EQUAL(parse_value, "1979-05-27T07:32:00.999999Z",
        value, value(toml::local_datetime(
            toml::date(1979, 5, 27), toml::hours(7) + toml::minutes(32) +
            toml::milliseconds(999) + toml::microseconds(999)),
            time_zone_ptr(new boost::local_time::posix_time_zone("UTC"))));

    {
        const std::string token("1979-05-27T18:50:00-04:00");
        std::string::const_iterator iter(token.begin());
        const result<toml::value, std::string> r =
            parse_value(iter, token.end());
        const toml::local_datetime answer(
            toml::date(1979, 5, 27), toml::hours(22) + toml::minutes(50));

        BOOST_CHECK(r.is_ok());
        BOOST_CHECK(r.unwrap().get<toml::offset_datetime>().utc_time() == answer);
    }
}
